...
interface SimpleEditableElementProps {
...
const EditableElement: React.FC<SimpleEditableElementProps> = ({
  children,
  elementType = 'div',
  onTextChange,
  initialText,
  ...
  }, [isDragging, isResizing, isEditMode, isPinned, dragStart, resizeStart, size, resizeHandle, hasBeenMoved, enforceContentAreaBounds]);
  ...
  }, [isAbsolutePositioned, hasBeenMoved, position, size, enforceContentAreaBounds]);
